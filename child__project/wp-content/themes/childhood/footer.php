        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="201" title="Форма для всплывающего меню"]') ?>
            </div>
        </div>
        <footer>
            <div class="container">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            <div class="footer__social-item">
                                <?php the_field('about_footer_social_title',2) ?>
                            </div>
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    <a href="tel:+797867834347"><?php the_field('about_footer_phone_1',2) ?></a>
                                    <a href="tel:+797867834358"><?php the_field('about_footer_phone_2',2) ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
                                <img src="<?php echo bloginfo("template_url"); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="footer__contacts-logo">
                                <address><?php the_field('about_footer_adress',2) ?></address>
                            </div>
                        </div>
                    </div>
                </div>
