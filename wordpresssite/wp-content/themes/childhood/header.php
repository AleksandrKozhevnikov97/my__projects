                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="<?php the_field('about_header_mail', 2); ?>" class="header__contacts-mail"><?php the_field('about_header_mail', 2); ?></a>
                            </div>
                            <div class="header__contacts-item">
                                ...
                                <div class="header__contacts-tel">
                                    <a href="tel:+797867834347"><?php the_field('about_header_phone_1', 2); ?></a>
                                    <a href="tel:+797867834358"><?php the_field('about_header_phone_2', 2); ?></a>
                                </div>
                            </div>
                            <div class="header__contacts-item">
                                <img src="<?php echo bloginfo("template_url"); ?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="header__contacts-logo">
                                <address><?php the_field('about_header_adress', 2); ?></address>
                            </div>
                        </div>
                    </div>
                </div>
